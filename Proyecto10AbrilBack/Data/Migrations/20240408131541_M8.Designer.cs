...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "3d7cdba0-0406-40fd-944f-09f91b8856e5",
                            Name = "Administrador",
                            NormalizedName = "ADMINISTRADOR"
                        },
                        new
                        {
                            Id = "6b6ea5cd-2c64-4efc-940c-0b8dd370878e",
                            Name = "Visitante",
                            NormalizedName = "VISITANTE"
                        },
                        new
                        {
                            Id = "52db4866-6963-49b2-a6a9-23133f222352",
                            Name = "Abonado",
                            NormalizedName = "ABONADO"
                        },
                        new
                        {
                            Id = "17d32e00-51d2-4ca7-8d42-8eb658e425a1",
                            Name = "Entrenador",
                            NormalizedName = "ENTRENADOR"
                        },
                        new
                        {
                            Id = "b88e8ef8-f926-466e-b7f9-373b30539408",
                            Name = "Jugador",
            ...
            modelBuilder.Entity("Proyecto10AbrilBack.Models.Partido", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProyectoCore10AbrilBack.Models.Categoria", b =>
                {
                    b.HasOne("ProyectoCore10AbrilBack.Models.Jugador", "Jugador")
                        .WithOne("Categoria")
                        .HasForeignKey("ProyectoCore10AbrilBack.Models.Categoria", "JugadorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
