...
namespace Proyecto10AbrilBack.Data.Migrations
{
    ...
    [Migration("20240320224642_Inicio")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "ba16e9c5-400a-4bf3-80e8-4b361644e067",
                            Name = "Administrador",
                            NormalizedName = "ADMINISTRADOR"
                        },
                        new
                        {
                            Id = "c9268dc8-e70a-4c5d-bdbd-a29a50c82cde",
                            Name = "Visitante",
                            NormalizedName = "VISITANTE"
                        },
                        new
                        {
                            Id = "6bb633f9-1652-4898-aff9-1414b51ca439",
                            Name = "Abonado",
                            NormalizedName = "ABONADO"
                        },
                        new
                        {
                            Id = "2accea02-2a7e-4ddc-b812-bd15fa99bb40",
                            Name = "Entrenador",
                            NormalizedName = "ENTRENADOR"
                        },
                        new
                        {
                            Id = "68d4752c-d4e7-4116-b277-82e5f8b78ff8",
                            Name = "Jugador",
            ...
            modelBuilder.Entity("ProyectoCore10AbrilBack.Models.Producto", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ProductoId = 10,
                            ProductoNombre = "Pelota de tenis",
                            ProductoPrecio = "10"
                        },
                        new
                        {
                            ProductoId = 11,
                            ProductoNombre = "Raqueta de pádel",
                            ProductoPrecio = "20"
                        },
                        new
                        {
                            ProductoId = 12,
                            ProductoNombre = "Saco de boxeo",
                            ProductoPrecio = "50"
                        },
                        new
                        {
                            ProductoId = 13,
                            ProductoNombre = "Cinta para correr",
                            ProductoPrecio = "200"
                        },
                        new
                        {
                            ProductoId = 14,
                            ProductoNombre = "Bicicleta estática",
                            ProductoPrecio = "300"
                        },
                        new
                        {
                            ProductoId = 15,
                            ProductoNombre = "Balón medicinal",
                            ProductoPrecio = "20"
                        },
                        new
                        {
